...
The service returns an `imageUrl` that can be added to a desired product using the Product Library API.
...
|`imageLookupKey`|_string_|_body_|_optional_|Lookup key.
|===
