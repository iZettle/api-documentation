...
If stock alerts are enabled for a product, then Zettle clients will also add the product to the low stock view if the number of items available is less than the threshold level.
