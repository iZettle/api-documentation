...
== About Purchase API
Provides read only information about purchases made through iZettle.
...
=== [[example3]]__Purchases with discounts returned.__
====
--
