...
When applying the total discounts on the purchase price, the discounts set on rows will be calculated first and subtracted from the total price followed by any discount set on the entire chart.
...
| Cart discount | | | 30% 
|===
To calculate the total discount, we start by calculating the discount per row. The first row contains one item and has a fixed discount of 5. 

The second row contains five items and a percentage discount of 10%:

*Row discounts* = 5 + 10 x 5 x 0.1 = 10.  

Then we calculate the cart discount, based on the total price of the cart, minus the row discounts:

*Total cart price* = 20 + 10 x 5 = 70.

*Cart discount* = (70 - 10) x 0.3 = 18

So the total discount on this purchase is: 10 + 18 = 28. And the total sum to pay is: 70 - 28 = 42.
...
```
{
  "purchases": [
    {
      "purchaseUUID": "Qq74IOcDEeaJxS84XJ93-w",
      "amount": 4200,
      "country": "SE",
      "currency": "SEK",
      "timestamp": "2017-01-30T15:46:31.808+0000",
      "purchaseNumber": 77,
      "userDisplayName": "Elna Westman",
      "userId": 1713921,
      "organizationId": 14184411,
      ...
      "cashPayments": [
        {
          "cashPaymentUUID": "457e44c0-e703-11e6-a350-ba4b93320a36",
          "amount": 4200,
          "handedAmount": 4200,
          "cashPaymentUUID1": "457e44c0-e703-11e6-a350-ba4b93320a36"
        }
      ],
      "receiptCopyAllowed": true,
      "published": true,
      "purchaseUUID1": "42aef820-e703-11e6-89c5-2f385c9f77fb",
      "groupedVatAmounts": {},
      "refund": false,
      "refunded": false
    }
  ],
  "firstPurchaseHash": "1485787109529wXk0kOb5EeaElIl84iyLHg",
  "lastPurchaseHash": "1485788787591qt9j4Ob9EeaEvmSHcH58vw"
}
```
