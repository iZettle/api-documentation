...
====
****
You can use the `self` path parameter instead of specifying organization UUID when calling the APIs. Or, you can call the following endpoint to fetch the organization UUID.
[source]
--
